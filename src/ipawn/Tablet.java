...
public class Tablet extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        item.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Apple", "Samsung", "Lenovo", "Huawei", "ASUS", "Google", "SONY", "Dell", "Xiaomi", "Realme" }));
        item.setBorder(null);
