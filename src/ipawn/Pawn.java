...
public class Pawn extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        term.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "60 Days", "3 Months", "4 Months", "5 Months", "6 Months", "7 Months", "8 Months" }));
        term.setBorder(null);
        ...
        brand.setBounds(890, 120, 230, 30);
        ...
        item.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Smartphone", "Laptop", "Jewelry", "Watch", "Tablet/iPad", "DSLR/Camera", "Gaming Console" }));
        item.setBorder(null);
        item.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        getContentPane().add(item);
        item.setBounds(510, 120, 230, 30);
        ...
        jLabel2.setBounds(-3, -4, 1220, 670);
