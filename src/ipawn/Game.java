...
public class Game extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        item.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "SONY (Play Station)", "Xbox", "Nintendo", "Panasonic", "Sega", "Ouya" }));
        item.setBorder(null);
        ...
        jButton1.setBounds(400, 40, 60, 20);
