...
public class Laptop extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        item.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Lenovo", "Apple Mac Book", "Realme", "Xiaomi", "Huawei", "HP", "Acer", "ASUS ROG", "Samsung", "Dell" }));
        item.setBorder(null);
        ...
        jButton1.setBounds(410, 40, 60, 20);
